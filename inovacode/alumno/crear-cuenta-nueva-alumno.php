...
<body class="alumno-body">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary ">
        <div class="container-fluid">
            ...
            <div>
                <a href="login-alumno.php" class="btn btn-custom">Regresar a inicio de sesión</a>
            </div>
        ...
        <div class="card p-4 ">
            ...
            if (isset($_GET['error'])) {
                ...
                if ($_GET['error'] == "duplicado") {
                    echo "<div class='alert alert-danger' role='alert'>Ya existe una cuenta creada con el numero de control ingresado.</div>";
                }
            ...
            <form action="../php/crud-cuentas-alumnos/insertar-alumno-alumno.php" method="post">
